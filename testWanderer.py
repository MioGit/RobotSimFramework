...
myplanner = pl.SmoothWanderer(robot)
...
def draw_text_stuff():
    lines = ["Ideal speed and rotation: " + str(myplanner.lastIdealSpeed) + " " + str(myplanner.lastIdealRotation), "Travelled distance: " + str(myplanner.currentDistance)]
